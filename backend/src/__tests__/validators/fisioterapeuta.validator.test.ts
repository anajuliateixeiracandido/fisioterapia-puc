...
describe('professorCadastroSchema', () => {
  ...
  it('deve rejeitar email fora do dominio', () => {
    expect(() =>
  ...
  it('deve rejeitar codigoPessoa com menos de 5 digitos', () => {
    expect(() =>
      professorCadastroSchema.parse({ ...dadosProfessorValido, codigoPessoa: '123' })
    ).toThrow()
  })

  it('deve rejeitar codigoPessoa com mais de 10 digitos', () => {
    expect(() =>
...
describe('alunoCadastroSchema', () => {
  it('deve rejeitar dados validos sem professor', () => {
