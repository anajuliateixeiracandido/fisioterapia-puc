...
import { comparePassword, generateRefreshToken, hashRefreshToken, hashPassword } from '../utils/hash.utils'
...
console.log('HASH GERADO:', tokenHash)
...
console.log('FISIOTERAPEUTA ENCONTRADO:', fisioterapeuta?.id ?? 'NÃO ENCONTRADO')
console.log('HASH NO BANCO:', fisioterapeuta?.refreshTokenHash ?? 'NENHUM')
