...
const accessToken = signAccessToken({
  ...
  coordenador: fisioterapeuta.professor?.coordenador ?? false,
})
...
return {
  ...
  user: {
    ...
    role: fisioterapeuta.role,
    coordenador: fisioterapeuta.professor?.coordenador ?? false,
    codigoPessoa: fisioterapeuta.professor?.codigoPessoa ?? null,
    matricula: fisioterapeuta.aluno?.matricula ?? null,
  },
}
}
