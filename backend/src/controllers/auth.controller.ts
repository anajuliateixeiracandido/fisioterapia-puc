...
import { login, logout, forgotPassword, resetPassword, refreshToken } from '../services/auth.service'
...
async function resetPasswordController(req: Request, res: Response, next: NextFunction): Promise<void> {
try {
...
async function refreshTokenController(req: Request, res: Response, next: NextFunction): Promise<void> {
try {
